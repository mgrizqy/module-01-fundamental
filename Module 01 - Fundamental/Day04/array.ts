...
// array.length : mengetahu banyak data didalam array

console.log(daftarSiswa.length);


// array.splice(pilihanIndex, jumlahDataYangDihapus, newData?) :
//  menghapus, memperbarui dan menyisipkan data baru pada index yang dipilih
